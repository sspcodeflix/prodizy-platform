...
class Settings(BaseSettings):
    ...
    LLAMA_API_ENDPOINT: str = os.getenv("LLAMA_API_ENDPOINT", "http://localhost:11434/v1")
    ...
    BACKEND_API_URL: str = os.getenv("BACKEND_API_URL", f"http://127.0.0.1:{os.getenv('API_PORT', '5003')}/")
